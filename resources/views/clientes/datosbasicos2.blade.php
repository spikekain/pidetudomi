...
{!! Form::model($clientes,['route'=>['clientes.update',$clientes->id],'method'=>'PUT','class'=>' form-horizontal form-label-left']) !!}
...
<div class="form-group ">
        ...
        {!!Form::text('coordenadas',null,['class'=>'form-control','placeholder'=>'Barrio', 'id'=>'cordenadas_destinatario', 'hidden'=>'true'])!!}
        </div>
</div>
<div class="form-group ">
