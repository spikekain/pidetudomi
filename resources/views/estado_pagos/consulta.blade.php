                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td align="right"><input  readonly value= "{!!($cantidad_servicio)!!}"  type="text" class="form-control" placeholder="0"></td>
                            <td><strong>Total Servicios</strong></td>
                            <td align="right"><input  readonly value= "{!!($total_servicio)!!}"  type="text" class="form-control" placeholder="0"></td>
                ...
                <table class="table table-striped jambo_table bulk_action">
                  ...
                  <tbody>
                    ...
                    <tr class="even pointer">
                      ...
                      <td class="text-right "><a href="/estado_pagos/detalle/{{$fecha_inicio}}/{{$fecha_fin}}/{{$dato->id_contratista}}"><img data-toggle="tooltip" title="Detalle" class="img-rounded" style="max-height:40px;" src="/images/lupa.png" ></td>
