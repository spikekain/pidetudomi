    ...
    <div class="">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <form class="form-horizontal" action="/analisis_servicios/consulta" method="post">
      ...
      <div class="">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2><i class="fa fa-bars"></i> Analisis de Servicios</h2>
         ...
         function drawChart() {
           ...
           var data = google.visualization.arrayToDataTable([
             ["Fecha", "Cantidad", { role: "style" } ],
               ...
               ["{{$servicio->dia}}",{{$servicio->cantidad_servicio}},"<?php
               switch ($cantidad % 5) {
    case 0:
        echo "#4da6f9";
        break;
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ["Fecha", "Cantidad", { role: "style" } ],
                @foreach ($servicios as $servicio)
                <?php $cantidad=$cantidad + 1; ?>
            ["{{$servicio->dia}}",{{$servicio->suma}},"<?php
            switch ($cantidad % 5) {
 case 0:
     echo "#4da6f9";
     break;
